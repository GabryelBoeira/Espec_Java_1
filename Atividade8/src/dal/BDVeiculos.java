...
public class BDVeiculos {
	...
	public BDVeiculos() {
		...
		cargaList.add(new Carga(7000, 30000 ,"BRA0S11", "Volkswagen", "Constellation 24.250", 150 ,  "black piano", 12, 250, 0));
		...
		cargaList.add(new Carga(9000, 47000 ,"BRA0S11", "Volkswagen", "Constellation 19.320", 150 , "black piano", 12, 320, 0));
				
		passeioList.add(new Passeio("BRA0S12", "Toyota", "Corola", 210 , 4, "black piano", 154, 5, 0));
		passeioList.add(new Passeio("BRA0S10", "Honda", "Civic", 202, 4,  "black piano", 155, 5, 0));
		passeioList.add(new Passeio("BRA0S11", "Chevrolet", "Cruze", 197, 4,  "black piano", 150, 5, 0));
		passeioList.add(new Passeio("BRA0S13", "Volkswagen", "Jetta GTI", 210, 4,  "black piano", 211, 5, 0));
		passeioList.add(new Passeio("BRA0S14", "Caoa Chery", "Arrizo 6", 220, 4, "black piano", 5, 150 , 5));		
	}
